 ...
 */
import type { AutomatonConfig, AutomatonDatabase, ConwayClient, AutomatonIdentity, FinancialState, SurvivalTier } from "../types.js";
 ...
 */
export declare function checkResources(identity: AutomatonIdentity, conway: ConwayClient, db: AutomatonDatabase, config?: AutomatonConfig): Promise<ResourceStatus>;
/**
